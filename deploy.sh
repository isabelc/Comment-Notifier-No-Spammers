...
# main config
PLUGINSLUG="comment-notifier-no-spammers" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="comment-notifier-no-spammers.php" # this should be the name of your main php file in the wordpress plugin
